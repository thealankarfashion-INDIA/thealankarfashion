...
export default function Profile() {
  const { user, signInWithGoogle, signInWithEmail, signUpWithEmail, logout, loading, error, clearError } = useAuth();
          ...
          <>
            ...
            <div className="flex justify-center gap-4 mb-6">
              <button onClick={signInWithGoogle}
                className="flex items-center gap-3 px-5 py-3 rounded-xl border border-gray-200 shadow-sm hover:bg-gray-50 hover:shadow-md transition-all group">
                ...
                <span className="text-sm font-semibold text-[#8E5E4F]">Sign in with Google</span>
              </button>
            </div>
          </>
        )}
