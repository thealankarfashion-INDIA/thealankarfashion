...
Deno.serve(async (req) => {
  ...
  if (
    ...
    (razorpayOrder.receipt && razorpayOrder.receipt !== appOrderId) ||
  ...
  const orderResult = await markOrderPaid(supabase, appOrderId, order, razorpay_payment_id, razorpay_order_id);
